  ...
  // Add event listeners
   ...
   // parent.switchConfig("memory_game");
        if (training == true){
          ...
          var instructions_text = document.getElementById('instructions_text');
          instructions_text.innerHTML = "Every time you hear either of these sounds, press the blue button on the tablet. If it is one of the correct sounds, you will feel a vibration on your wrist. Press next to move onto the training.";
          training = true;
        }
