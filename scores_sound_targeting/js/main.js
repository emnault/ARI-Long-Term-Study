...
class DefaultWeb {
    ...
    firstFrase() {
        ...
        this.tts_action.sendGoal({
            rawtext: {
                text: "<mark name='doTrick trickName=show_right'/> Good concentration on this game. Here is some data on your performance.", 
                lang_id: "en_GB"
            }
        }, (response) => {
...
//  shapes_demo.init();
  ...
  document.getElementById("score").innerHTML = "Score: " + localStorage.getItem('numCorrect') + "/" + localStorage.getItem('totalTargetSounds');
