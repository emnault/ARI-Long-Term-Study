...
//  shapes_demo.init();
  ...
  // Add event listeners
   ...
   // parent.switchConfig("memory_game");
    window.open("../instructions_sound_targeting_lts_V4/index.html", "_self");
  });
