  ...
  // Add event listeners
   ...
   // parent.switchConfig("memory_game");
        if (training == true){
          ...
          var instructions_text = document.getElementById('instructions_text');
          instructions_text.innerHTML = "If you get it wrong, you can try again until you categorise it correctly. You will feel a vibration on your wrist for every 5 images you categorise. The goal is to complete the task both quickly and accurately. Press next to move onto the training.";
          training = true;
        }
